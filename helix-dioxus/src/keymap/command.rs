...
const COMMAND_REGISTRY: &[(&str, CommandSlot)] = &[
    ...
    ("move_prev_word_start", CommandSlot::Cmd(EditorCommand::MoveWordBackward)),
    ("move_next_word_end", CommandSlot::Cmd(EditorCommand::MoveWordEnd)),
    ("move_next_long_word_start", CommandSlot::Cmd(EditorCommand::MoveLongWordForward)),
    ("move_prev_long_word_start", CommandSlot::Cmd(EditorCommand::MoveLongWordBackward)),
    ("move_next_long_word_end", CommandSlot::Cmd(EditorCommand::MoveLongWordEnd)),
    ("goto_line_start", CommandSlot::Cmd(EditorCommand::MoveLineStart)),
    ("goto_line_end", CommandSlot::Cmd(EditorCommand::MoveLineEnd)),
    ("goto_first_nonwhitespace", CommandSlot::Cmd(EditorCommand::GotoFirstNonWhitespace)),
    ...
    ("goto_last_accessed_file", CommandSlot::Cmd(EditorCommand::GotoLastAccessedFile)),
    ("goto_last_modified_file", CommandSlot::Cmd(EditorCommand::GotoLastModifiedFile)),
    ("goto_last_modification", CommandSlot::Cmd(EditorCommand::GotoLastModification)),
    ...
    ("find_till_char_reverse", CommandSlot::AwaitChar(AwaitCharKind::TillBackward)),
    ("repeat_last_motion", CommandSlot::Cmd(EditorCommand::RepeatLastFind)),
    ("search_word_under_cursor", CommandSlot::Cmd(EditorCommand::SearchWordUnderCursor)),
    ...
    ("insert_at_line_start", CommandSlot::Cmd(EditorCommand::EnterInsertModeLineStart)),
    ("append_mode", CommandSlot::Cmd(EditorCommand::EnterInsertModeAfter)),
    ("insert_at_line_end", CommandSlot::Cmd(EditorCommand::EnterInsertModeLineEnd)),
    ...
    ("change_selection_noyank", CommandSlot::Cmd(EditorCommand::ChangeSelectionNoYank)),
    ...
    ("toggle_block_comments", CommandSlot::Cmd(EditorCommand::ToggleBlockComment)),
    ...
    ("commit_undo_checkpoint", CommandSlot::Cmd(EditorCommand::CommitUndoCheckpoint)),
    // Selection
    ...
    ("extend_to_line_bounds", CommandSlot::Cmd(EditorCommand::ExtendToLineBounds)),
    ("shrink_to_line_bounds", CommandSlot::Cmd(EditorCommand::ShrinkToLineBounds)),
    ...
    ("keep_primary_selection", CommandSlot::Cmd(EditorCommand::KeepPrimarySelection)),
    ...
    ("extend_next_word_start", CommandSlot::Cmd(EditorCommand::ExtendWordForward)),
    ("extend_prev_word_start", CommandSlot::Cmd(EditorCommand::ExtendWordBackward)),
    ("extend_next_word_end", CommandSlot::Cmd(EditorCommand::ExtendWordEnd)),
    ("extend_next_long_word_start", CommandSlot::Cmd(EditorCommand::ExtendLongWordForward)),
    ("extend_prev_long_word_start", CommandSlot::Cmd(EditorCommand::ExtendLongWordBackward)),
    ("extend_next_long_word_end", CommandSlot::Cmd(EditorCommand::ExtendLongWordEnd)),
    ...
    ("extend_to_first_nonwhitespace", CommandSlot::Cmd(EditorCommand::ExtendGotoFirstNonWhitespace)),
    ("extend_goto_column", CommandSlot::Cmd(EditorCommand::ExtendGotoColumn)),
    ("extend_to_file_start", CommandSlot::Cmd(EditorCommand::ExtendToFirstLine)),
    ...
    // Multi-selection
    ("split_selection_on_newline", CommandSlot::Cmd(EditorCommand::SplitSelectionOnNewline)),
    ("copy_selection_on_next_line", CommandSlot::Cmd(EditorCommand::CopySelectionOnNextLine)),
    ("copy_selection_on_prev_line", CommandSlot::Cmd(EditorCommand::CopySelectionOnPrevLine)),
    ("rotate_selections_forward", CommandSlot::Cmd(EditorCommand::RotateSelectionsForward)),
    ("rotate_selections_backward", CommandSlot::Cmd(EditorCommand::RotateSelectionsBackward)),
    // Clipboard
    ("yank", CommandSlot::Cmd(EditorCommand::Yank)),
    ("yank_main_selection_to_clipboard", CommandSlot::Cmd(EditorCommand::YankMainSelectionToClipboard)),
    ...
    ("delete_selection_noyank", CommandSlot::Cmd(EditorCommand::DeleteSelectionNoYank)),
    ("replace_with_yanked", CommandSlot::Cmd(EditorCommand::ReplaceWithYanked)),
    ("select_register", CommandSlot::AwaitChar(AwaitCharKind::SelectRegister)),
    // Surround
    ("select_textobject_inner", CommandSlot::AwaitChar(AwaitCharKind::SelectInsidePair)),
    ("select_textobject_around", CommandSlot::AwaitChar(AwaitCharKind::SelectAroundPair)),
    ...
    ("surround_replace", CommandSlot::AwaitChar(AwaitCharKind::SurroundReplaceFrom)),
    // Search
    ("search", CommandSlot::Cmd(EditorCommand::EnterSearchMode { backwards: false })),
    ("rsearch", CommandSlot::Cmd(EditorCommand::EnterSearchMode { backwards: true })),
    ("search_next", CommandSlot::Cmd(EditorCommand::SearchNext)),
    ("search_prev", CommandSlot::Cmd(EditorCommand::SearchPrevious)),
    // Regex
    ("select_regex", CommandSlot::Cmd(EditorCommand::EnterRegexMode { split: false })),
    ("split_selection", CommandSlot::Cmd(EditorCommand::EnterRegexMode { split: true })),
    // Command mode
    ("command_mode", CommandSlot::Cmd(EditorCommand::EnterCommandMode)),
    // Pickers
    ("file_picker", CommandSlot::Cmd(EditorCommand::ShowFilePicker)),
    ("file_picker_in_current_buffer_directory", CommandSlot::Cmd(EditorCommand::ShowFilePickerInBufferDir)),
    ("file_explorer", CommandSlot::Cmd(EditorCommand::ShowFileExplorer)),
    ("file_explorer_in_current_buffer_directory", CommandSlot::Cmd(EditorCommand::ShowFileExplorerInBufferDir)),
    ...
    ("workspace_symbol_picker", CommandSlot::Cmd(EditorCommand::ShowWorkspaceSymbols)),
    ("diagnostics_picker", CommandSlot::Cmd(EditorCommand::ShowDocumentDiagnostics)),
    ("workspace_diagnostics_picker", CommandSlot::Cmd(EditorCommand::ShowWorkspaceDiagnostics)),
    ("changed_file_picker", CommandSlot::Cmd(EditorCommand::ShowChangedFilesPicker)),
    ...
    ("goto_type_definition", CommandSlot::Cmd(EditorCommand::GotoTypeDefinition)),
    ("goto_implementation", CommandSlot::Cmd(EditorCommand::GotoImplementation)),
    ...
    ("select_references_to_symbol_under_cursor", CommandSlot::Cmd(EditorCommand::SelectReferencesToSymbol)),
    ...
    // Shell
    ("shell_pipe", CommandSlot::Cmd(EditorCommand::EnterShellMode(ShellBehavior::Replace))),
    ("shell_pipe_to", CommandSlot::Cmd(EditorCommand::EnterShellMode(ShellBehavior::Ignore))),
    ("shell_insert_output", CommandSlot::Cmd(EditorCommand::EnterShellMode(ShellBehavior::Insert))),
    ("shell_append_output", CommandSlot::Cmd(EditorCommand::EnterShellMode(ShellBehavior::Append))),
    // Jump list
    ...
    ("delete_char_backward", CommandSlot::Cmd(EditorCommand::DeleteCharBackward)),
    ("delete_char_forward", CommandSlot::Cmd(EditorCommand::DeleteCharForward)),
    ("delete_word_backward", CommandSlot::Cmd(EditorCommand::DeleteWordBackward)),
    ("delete_word_forward", CommandSlot::Cmd(EditorCommand::DeleteWordForward)),
    ...
    ("extend_till_prev_char", CommandSlot::AwaitChar(AwaitCharKind::TillBackward)),
    // Mode aliases
    ("exit_select_mode", CommandSlot::Cmd(EditorCommand::ExitSelectMode)),
    // Comment alias
    ("toggle_line_comments", CommandSlot::Cmd(EditorCommand::ToggleLineComment)),
    ...
    ("extend_to_line_end_newline", CommandSlot::Cmd(EditorCommand::ExtendLineEnd)),
    ...
    // Picker aliases
    ("file_picker_in_current_directory", CommandSlot::Cmd(EditorCommand::ShowFilePicker)),
    ("file_explorer_in_current_directory", CommandSlot::Cmd(EditorCommand::ShowFileExplorer)),
];
...
mod tests {
    ...
    fn resolve_find_backward_select_mode() {
        ...
        assert!(matches!(
            cmds[0],
            EditorCommand::ExtendFindCharBackward('a')
        ));
    }
    ...
    fn resolve_till_forward_select_mode() {
        ...
        assert!(matches!(
            cmds[0],
            EditorCommand::ExtendTillCharForward('b')
        ));
    }
    ...
    fn resolve_till_backward_select_mode() {
        ...
        assert!(matches!(
            cmds[0],
            EditorCommand::ExtendTillCharBackward('c')
        ));
    }
    ...
    fn registry_goto_definition() {
        ...
        assert!(matches!(
            slot,
            CommandSlot::Cmd(EditorCommand::GotoDefinition)
        ));
    }
    ...
    fn registry_find_char() {
        ...
        assert!(matches!(
            slot,
            CommandSlot::AwaitChar(AwaitCharKind::FindForward)
        ));
    }
    ...
    fn registry_select_register() {
        ...
        assert!(matches!(
            slot,
            CommandSlot::AwaitChar(AwaitCharKind::SelectRegister)
        ));
    }
    ...
    fn registry_no_duplicates() {
        ...
        for (name, _) in COMMAND_REGISTRY {
            assert!(
                seen.insert(*name),
                "duplicate command name in registry: {name}"
            );
        }
    }
}
